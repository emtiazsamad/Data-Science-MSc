...
"""DISCLAIMER: The code is an edited version the 'dqn.py' 
file found at: https://github.com/michaelnny/deep_rl_zoo/tree/main/deep_rl_zoo/networks/dqn.py.
Areas which have been edited are sections marked by:
#//////////////////////////////////////////////////////////////////////////."""
...
class R2d2DqnMlpNet(nn.Module):
    ...
    def __init__(self, input_shape: int, num_actions: int):
        ...
        #The section identified below indicates areas where the code has been changed.

        #//////////////////////////////////////////////////////////////////////////

        self.advantage_1 = nn.Sequential(
            nn.Linear(self.lstm.hidden_size, self.lstm.hidden_size),
            nn.ReLU(),
        )
        self.advantage_2 = nn.Sequential(
            nn.Linear(self.lstm.hidden_size * 2, 128),
            nn.ReLU(),
        )
        ...
        self.advantage_4 = nn.Linear(self.lstm.hidden_size * 2, num_actions)
        ...
        self.value_4 = nn.Linear(self.lstm.hidden_size * 2, 1)
    ...
    def forward(self, input_: RnnDqnNetworkInputs) -> RnnDqnNetworkOutputs:
        ...
        a = self.advantage_1(x)  # [T*B, num_actions]
        ...
        a = torch.cat([a, x], dim=-1)
        a = self.advantage_4(a)
        
        v = self.value_1(x)  # [T*B, 1]
...
class R2d2DqnConvNet(nn.Module):
    ...
    def __init__(self, input_shape: int, num_actions: int):
        ...
        self.advantage_2 = nn.Sequential(
            nn.Linear(self.lstm.hidden_size * 2, 512),
            nn.ReLU(),
        )
        self.advantage_3 = nn.Sequential(
            nn.Linear(self.lstm.hidden_size * 2, 512),
